	...
	<div id="container">
		<div id="main_contents">
			<div style="margin-left: 35%">
				<form action="LoginController" method="post" name="confirm">
					<br />
					<table class="sortName">
						...
						<tr align="left">
							<td id="errormsg">${error } ${success }</td>
						</tr>

						<tr align="left">
							<td>User ID</td>

							<td><input type="text" class="normal_width1" value=""
								name="userid" /></td>
						</tr>
						...
						<tr align="left">
							...
							<td><input type="password" class="normal_width1" value=""
								name="password" /></td>
						</tr>
						<tr>
							<td colspan="2"><br />
