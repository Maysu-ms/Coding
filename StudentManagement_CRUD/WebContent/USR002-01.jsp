    ...
    <div id="container"> 
        ...
        <div id="main_contents">   
			<div id="contents">
				...
				<form name="registerForm" action="UserUpdate" method="post">
					<table class="tableForm">
						<tr>
							<td class="tblSingleLabel"> User ID *</td>
							<td class="tblSingleInput"><input type="text" class="txtlong_popup" id="txtUserName" value="${bean.id }" name="id" readonly="readonly"/></td>
						</tr>
						<tr>
							<td class="tblSingleLabel">User Name</td>
							<td class="tblSingleInput"><input type="text" class="txtlong_popup" id="txtUserName" value="${bean.name }" name="name"/></td>              
						</tr>
					...
					<input type="button" value="Back" class="button" onClick="window.location.replace('USR001.jsp')"/>
				</form>
